...
/**
 * Handles the disable auto sign in configuration setting.
 */
export class DisableAutoSignIn extends BaseRequest<undefined, undefined> {
  /**
  ...
  dispatchInternal() {
    ...
    this.channel.send(disableAutoSignInMessage(this.id));
  }
}
